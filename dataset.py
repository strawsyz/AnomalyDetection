...
def get_feature_filepath(video_id, test_mode, normal_mode):
...
def get_clip_feature(video_id, test_mode, normal_mode):
    video_id = video_id.split("/")[-1].replace(".mp4", "")
    feature_path = get_feature_filepath(video_id, test_mode, normal_mode)
